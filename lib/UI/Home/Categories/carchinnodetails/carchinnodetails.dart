...
class CarChinnoDetails extends StatefulWidget {
  var data;
  var details;
  int index;
  CarChinnoDetails({this.data, this.index, this.details});
  @override
  _CarChinnoDetailsState createState() => _CarChinnoDetailsState();
}

class _CarChinnoDetailsState extends State<CarChinnoDetails> {
  File _drawImage;
