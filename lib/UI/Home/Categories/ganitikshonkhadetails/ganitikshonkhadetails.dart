...
class GanitikShonkhaDetails extends StatefulWidget {
  var data;
  var details;
  int index;
  GanitikShonkhaDetails({this.data, this.index, this.details});
  @override
  _GanitikShonkhaDetailsState createState() => _GanitikShonkhaDetailsState();
}

class _GanitikShonkhaDetailsState extends State<GanitikShonkhaDetails> {
  File _drawImage;
