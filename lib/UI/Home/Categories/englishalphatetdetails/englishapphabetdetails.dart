...
class EnglishAlphabetDetails extends StatefulWidget {
  var data;
  var details;
  int index;
  EnglishAlphabetDetails({this.data, this.index, this.details});
  @override
  _EnglishAlphabetDetailsState createState() => _EnglishAlphabetDetailsState();
}

class _EnglishAlphabetDetailsState extends State<EnglishAlphabetDetails> {
  ...
  void initState() {
    ...
    myInterstitial = InterstitialAd(
      ...
      // https://developers.google.com/admob/ios/test-ads
       ...
       adUnitId: "ca-app-pub-7644770608554471/3686495425",
