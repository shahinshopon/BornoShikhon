...
class EnglishShonkhaDetails extends StatefulWidget {
  var data;
  var details;
  int index;
  EnglishShonkhaDetails({this.data, this.index, this.details});
  @override
  _EnglishShonkhaDetailsState createState() => _EnglishShonkhaDetailsState();
}

class _EnglishShonkhaDetailsState extends State<EnglishShonkhaDetails> {
  File _drawImage;
